 ...
 *   - "neon"      → gradient tím-xanh trôi chậm, cảm giác "tech/cyberpunk"
 *   - "particles" → các chấm/đường nối di chuyển nhẹ trên nền tối, cảm giác "data/network"
 */
export const AnimatedBackground: React.FC<AnimatedBackgroundProps> = ({
  ...
  if (theme === "neon") {
    // Gradient di chuyển chậm dãi theo thời gian (loop mượt trong suốt slide).
